...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		JLabel lblNewLabel_2 = new JLabel("GLOSS SALARY:");
		...
		lblNewLabel_2_1.setBounds(309, 171, 132, 41);
		...
		btnComputation.setBackground(new Color(0, 0, 64));
		btnComputation.setForeground(new Color(255, 255, 255));
		btnComputation.setBounds(378, 236, 89, 23);
